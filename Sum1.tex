...
\]
and so composing this with the linear map $\mathrm{Sum}_0(X,-)\colon [\mathbf{1}_X,\mathbf{1}_X]\to \mathbb{C}$ we get a bilinear pairing $\langle\,|\,\rangle_X$ between $[\mathbf{1}_X,\rho]$ and $[\rho,\mathbf{1}_X]$. Equivalently, this is a linear map
\[
...
\]
	%Similarly, $v$ can be uniquely written as a sum of elements $v_y$ vanishing outside the isomorphism class of $y$ in $Y$. 
